 ...
 */
export abstract class SecurityTasksService {
  /**
   ...
   * @example
   * ```typescript
   * this.securityTasksService.tasks$.subscribe(tasks => {
   ...
   * @example
   * ```typescript
   * this.securityTasksService.unassignedCriticalCipherIds$.subscribe(ids => {
   ...
   * @example
   * ```typescript
   * this.securityTasksService.getTaskMetrics$(orgId).subscribe(metrics => {
   ...
   * @example
   * ```typescript
   * this.securityTasksService.loadTasks$(orgId).subscribe();
   * ```
   */
