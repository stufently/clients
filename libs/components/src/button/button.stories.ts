  ...
  render: (args) => ({
    ...
    template: /*html*/ `
      <span class="tw-flex tw-gap-8">
        <div>
          <button type="button" startIcon="bwi-add" bitButton [buttonType]="buttonType" [block]="block">
            Button label
          </button>
        </div>
        <div>
          <button type="button" endIcon="bwi-add" bitButton [buttonType]="buttonType" [block]="block">
            Button label
          </button>
        </div>
      </span>
