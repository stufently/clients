...
<i class="bwi bwi-more-horizontal"> </i> icon button, and then the page directly above the current page.

When the user selects the <i class="bwi bwi-more-horizontal"></i> icon button, a menu opens displaying
