...
const _EventType = Object.freeze({
  // User (1000)
  User_LoggedIn: 1000,
  ...
  // ProviderOrganization (1900)
  ProviderOrganization_Created: 1900,
  ProviderOrganization_Added: 1901,
  ProviderOrganization_Removed: 1902,
  ProviderOrganization_VaultAccessed: 1903,

  // OrganizationDomain (2000)
  ...
  Secret_GroupAccessGranted: 2109,
  Secret_GroupAccessRevoked: 2110,
  Secret_GroupAccessUpdated: 2111,
  Secret_ServiceAccountAccessGranted: 2112,
  Secret_ServiceAccountAccessRevoked: 2113,
  Secret_ServiceAccountAccessUpdated: 2114,
  ...
  Project_UserAccessGranted: 2204,
  Project_UserAccessRevoked: 2205,
  Project_UserAccessUpdated: 2206,
  Project_GroupAccessGranted: 2207,
  Project_GroupAccessRevoked: 2208,
  Project_GroupAccessUpdated: 2209,
  Project_ServiceAccountAccessGranted: 2210,
  Project_ServiceAccountAccessRevoked: 2211,
  Project_ServiceAccountAccessUpdated: 2212,
  ...
  ServiceAccount_UserPermissionUpdated: 2306,
  ServiceAccount_GroupPermissionUpdated: 2307,
} as const);

type _EventType = typeof _EventType;

export type EventType = _EventType[keyof _EventType];

// FIXME: Update typing of `EventType` to be `Record<keyof _EventType, EventType>`
// which is ADR-0025 compliant when the TypeScript version is at least 5.8.
export const EventType: typeof _EventType = _EventType;

/**
 * Reverse mapping of EventType numeric values to their key names.
 *
 * When represented as an enum in TypeScript, this reverse mapping was provided
 * by default. Now using a constant object it needs to be defined manually.
 */
export const eventTypeNames = Object.freeze(
  Object.fromEntries(Object.entries(EventType).map(([key, value]) => [value, key])),
) as Readonly<Record<EventType, keyof typeof EventType>>;
